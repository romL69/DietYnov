...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recipesButton = findViewById(R.id.receipes);
        recipesButton.setOnClickListener(clickRecipiesListener);
    }
    ...
    private View.OnClickListener clickRecipiesListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
